  ...
  return (
    <footer style={{ 
      ...
      <div style={{ textAlign: 'center' }}>
        <p style={{ margin: '0.5rem 0', fontSize: '1.2rem', fontWeight: 'bold' }}>© 2024 EventApp</p>
        <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', marginBottom: '1rem' }}>
          <a href="/about" style={{ color: 'white', textDecoration: 'none', fontSize: '1rem', transition: 'color 0.3s' }} onMouseOver={(e) => e.target.style.color = 'grey'} onMouseOut={(e) => e.target.style.color = 'white'}>À propos</a>
          <a href="/contact" style={{ color: 'white', textDecoration: 'none', fontSize: '1rem', transition: 'color 0.3s' }} onMouseOver={(e) => e.target.style.color = 'grey'} onMouseOut={(e) => e.target.style.color = 'white'}>Contact</a>
          <a href="/privacy" style={{ color: 'white', textDecoration: 'none', fontSize: '1rem', transition: 'color 0.3s' }} onMouseOver={(e) => e.target.style.color = 'grey'} onMouseOut={(e) => e.target.style.color = 'white'}>Politique de confidentialité</a>
        </div>
